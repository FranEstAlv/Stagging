...
# NO escapa dos veces porque cada funcion solo escapa lo que a ELLA le
# llega, no lo que ya viene con tags de otra funcion -- ver crudo() para
# el caso "ya viene formateado, no lo toques".
#
# El modulo tambien puede ignorar todo esto y mandar su propio string HTML
# armado a mano a contexto.canal.publicar_texto(texto=...) -- no hay
# obligacion de pasar por estos helpers.
