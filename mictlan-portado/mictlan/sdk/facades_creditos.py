...
class CreditosFacade:
    ...
    Leccion directa del SDK real de ALFA-1: ahi el unico camino documentado
    para que un modulo cobrara era un atajo sin gate
    (bot_data['credit_service']) que SI dejaba acuñar creditos. Ese
    boquete no existe aca: el metodo otorgar() ni siquiera esta importado
    en este archivo."""
