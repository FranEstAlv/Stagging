...
# codigo. Ver "SDK de modulos externos (plan)" en CLAUDE.md. Constante
# compartida por manifiestos.py y ciclo_vida.py -- vive en su propio
# archivo para que ninguno de los dos "sea dueño" del otro.
