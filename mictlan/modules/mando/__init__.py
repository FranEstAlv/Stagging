...
# modulos.py) y expone su propio callback_data namespace bajo "mando:";
# este __init__.py solo hace de gate de permiso + router, nunca logica de
# negocio propia.
...
async def mando_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    # Namespace por seccion: "mando:usuarios" (exacto) o
    # "mando:mod:<...>" (variable, formato propio de modulos.py, incluida
    # la pagina cuando aplica) -- cada seccion parsea lo suyo, este router
    # solo mira el segundo segmento.
    partes = data.split(":")
