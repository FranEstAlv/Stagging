...
# primero que matchea).
#
# Espejo deliberado del flujo real de ALFA-1 (motivo -> foto, ver
# samaritan/core.py list_command/list_reason_handler/list_image_handler),
# reescrito de cero -- ver la regla prohibitiva de espejo en CLAUDE.md.
