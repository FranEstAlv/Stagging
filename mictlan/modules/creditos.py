...
# nunca expuesto a un modulo externo via contexto.creditos (ver sdk.py).
# Mismo criterio de "cero acceso administrativo fuera de /mando salvo
# comandos cortos ya existentes" que /perfil y /reporte, pero gateado a
# root + mismo chat que /mando (DM o grupo de gestion) porque acuñar
# creditos es una accion mas sensible que ver el propio perfil.
