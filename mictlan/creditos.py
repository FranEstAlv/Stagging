...
# db.py. Inspirado en CreditService de ALFA-1 (ver "Lo bueno -- replicar"
# en CLAUDE.md) pero con una asimetria deliberada: este modulo SI tiene
# otorgar() (acuñar creditos), pero contexto.creditos del SDK (sdk.py)
# NUNCA lo expone a un modulo externo -- solo cobrar()/reembolsar().
# Leccion directa de revisar el SDK real de ALFA-1 (PROGRESO.md,
# comparacion 2026-09-01): ahi el unico camino documentado para que un
# modulo cobrara era un atajo sin gate (bot_data["credit_service"]) que SI
# dejaba acuñar. Ese boquete no existe aca porque el metodo simplemente no
# esta expuesto por fuera de este archivo.
...
# permitir un doble gasto. Un solo Lock global es correcto acá porque todo
# el proceso comparte una unica conexion SQLite (ver _Pool en db.py) -- no
# hay paralelismo real de escritura que perder.
