...
# Links de invitacion de un solo uso -- espejo del concepto de ALFA-1
# (samaritan/services/event_logs_extended.py: single_use_invites),
# reescrito de cero y simplificado a proposito: member_limit=1 ya le basta
# a Telegram para invalidar el link despues del primer ingreso, asi que
# ESTE modulo no necesita un listener de chat_member ni revocar/rotar
# nada a mano (a diferencia de ALFA-1, que si tiene ese mecanismo extra) --
# decision explicita de Fernando de mantener solo el panel de
# generar/actualizar, sin deteccion automatica de uso.
#
# Dos flujos distintos generan links via este modulo (ver
# PROGRESO.md, sesion 2026-09-01):
